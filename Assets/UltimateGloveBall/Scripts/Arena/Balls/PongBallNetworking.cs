...
namespace PongHub.Arena.Balls
{
    ...
    /// 与原版BallNetworking的主要区别:
    /// 1. 球附着到非持拍手而非手套
    /// 2. 基于发球权限控制球的生成
    /// 3. 专门针对乒乓球物理特性优化
    /// </summary>
    public class PongBallNetworking : NetworkBehaviour
    {
        #region Events
        public event Action BallWasServedLocally;
        public event Action<PongBallNetworking, bool> BallDied;
        ...
        [SerializeField, AutoSet] private PongBallStateSync m_stateSync;
        [SerializeField, AutoSet] private PongBallAttachment m_ballAttachment;
        [SerializeField, AutoSet] private PongBallSpin m_ballSpin;
        [SerializeField] private PongBallPhysics m_ballPhysics;
        ...
        public PongBallSpin BallSpin => m_ballSpin;
        public PongBallPhysics BallPhysics => m_ballPhysics;
        #endregion
        ...
        private void Awake()
        {
            ...
            if (m_ballPhysics == null)
                m_ballPhysics = new PongBallPhysics();
